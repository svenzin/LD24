...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("gfx/Ant.png", NME_gfx_ant_png);
			resourceTypes.set ("gfx/Ant.png", "image");
			resourceClasses.set ("gfx/AntSource.png", NME_gfx_antsource_png);
			resourceTypes.set ("gfx/AntSource.png", "image");
			resourceClasses.set ("gfx/BasicBlock.png", NME_gfx_basicblock_png);
			resourceTypes.set ("gfx/BasicBlock.png", "image");
			...
			resourceClasses.set ("gfx/Enemy0.png", NME_gfx_enemy0_png);
			resourceTypes.set ("gfx/Enemy0.png", "image");
			resourceClasses.set ("gfx/Ship.png", NME_gfx_ship_png);
			resourceTypes.set ("gfx/Ship.png", "image");
			resourceClasses.set ("gfx/Tower.png", NME_gfx_tower_png);
			resourceTypes.set ("gfx/Tower.png", "image");
